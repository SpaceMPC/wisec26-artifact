...
protocols = sorted(['ps-rep-ring','sy-rep-ring','ps-rep-field','sy-rep-field','shamir','sy-shamir','malicious-rep-ring','malicious-shamir','replicated-field','malicious-rep-field','replicated-ring'])
#0=semi-honest 1=malicious
sec_guarantee = {'brain':1,'ps-rep-ring':1,'sy-rep-ring':1,'ps-rep-field':1,'replicated-ring':0,'replicated-field':0,'atlas':0,'shamir':0,'sy-rep-field':1,'sy-shamir':1,'malicious-rep-ring':1,'malicious-rep-field':1,'malicious-shamir':1}
...
ax[2].legend(ncol=2,handles=[blue_patch, red_patch],fontsize=text_size+8,loc='lower center',bbox_to_anchor=(.5, -0.87),)
fig.tight_layout()
